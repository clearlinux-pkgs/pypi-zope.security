...
Source0  : https://files.pythonhosted.org/packages/4e/29/32a30ed1f8a70da18aa18b80be1a64e2c6317727369f2525f7effd4d06a9/zope.security-5.1.0.tar.gz
...
%prep
%setup -q -n zope.security-5.1.0
cd %{_builddir}/zope.security-5.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582847522
...
cp %{_builddir}/zope.security-5.1.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/zope.security/a0b53f43aab58b46bf79ba756c50771c605ab4c5
