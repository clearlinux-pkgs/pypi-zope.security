...
Source0  : https://files.pythonhosted.org/packages/07/97/bd27aa741870aeb60c6ff5ba5d6b08a5e6a1c3a48074c19ed51588568d33/zope.security-7.0.tar.gz
...
%prep
%setup -q -n zope.security-7.0
cd %{_builddir}/zope.security-7.0
pushd ..
cp -a zope.security-7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717080857
