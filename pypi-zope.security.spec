...
Source0  : https://files.pythonhosted.org/packages/48/f5/1a5af27894ff7b9f7bcb7f84755365c7f4cf8e8c043f8c828b134955e54a/zope.security-7.1.tar.gz
...
%prep
%setup -q -n zope.security-7.1
cd %{_builddir}/zope.security-7.1
pushd ..
cp -a zope.security-7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723794263
